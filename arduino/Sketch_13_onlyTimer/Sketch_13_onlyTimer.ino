...
void menu0()
{
      DisplayText(0, 10, "LETS START", 5, 0, 1, false);
      DisplayText(0, 30, "Later (White)", 5, 0, 1, true);
      DisplayText(0, 45, "Continue (Blue)", 5, DISPLAY_TIME, 1, true);
      bool blue=0, white=0;
      while(menuLevel==0)
      {
      ...
      if(sw1) //To awake screen
      {
            for(int i=0; i<2; i++)
            {
                  if(menuLevel==2) //Door closed
                        ...
                        DisplayText(0, 47, "OPEN", 5, 2000, 2, false);
                  DisplayDateAndTime();
