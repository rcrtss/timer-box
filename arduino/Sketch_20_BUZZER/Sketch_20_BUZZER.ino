...
void openTone()
{
  tone(buzzer, C4); // Send 1KHz sound signal...
  delay(200);        // ...for 1sec
  tone(buzzer, E4); // Send 1KHz sound signal...
  delay(200);        // ...for 1sec
  tone(buzzer, G4); // Send 1KHz sound signal...
  delay(200);        // ...for 1sec
  tone(buzzer, A4); // Send 1KHz sound signal...
  delay(200);        // ...for 1sec
  tone(buzzer, E4); // Send 1KHz sound signal...
  delay(700);        // ...for 1sec
  tone(buzzer, C4); // Send 1KHz sound signal...
...
void closeTone()
{
  tone(buzzer, E4); // Send 1KHz sound signal...
  delay(200);        // ...for 1sec
  tone(buzzer, D4); // Send 1KHz sound signal...
  delay(200);        // ...for 1sec
  tone(buzzer, C4); // Send 1KHz sound signal...
  delay(200);        // ...for 1sec
  tone(buzzer, B3); // Send 1KHz sound signal...
  delay(200);        // ...for 1sec
  tone(buzzer, A3); // Send 1KHz sound signal...
  delay(200);        // ...for 1sec
  tone(buzzer, B3); // Send 1KHz sound signal...
  delay(400);        // ...for 1sec
  tone(buzzer, G3); // Send 1KHz sound signal...
  delay(200);        // ...for 1sec
  tone(buzzer, A3); // Send 1KHz sound signal...    
  delay(800);        // ...for 1sec
  noTone(buzzer);     // Stop sound...
