...
void menu1()
{
  ...
  DisplayText(0, 28, "Timer (Blue)", 5, 0, 1, true);
  DisplayText(0, 45, "Fridays (White)", 5, DISPLAY_TIME, 1, true);
  bool blue=0, white=0;
  while(menuLevel==1)
  {
...
{
  DisplayText(20, 10, "FRIDAYS", 5, DISPLAY_TIME, 2, false);
  DisplayText(0, 47, "Is door closed?", 5, DISPLAY_TIME, 1, true);
  bool blue=1;
  while(blue)
  {
    blue = digitalRead(BLUE_BUTTON);
